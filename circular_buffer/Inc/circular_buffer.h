...
#ifndef CIRCULAR_BUFFER_INC_CIRCULAR_BUFFER_H_
#define CIRCULAR_BUFFER_INC_CIRCULAR_BUFFER_H_
...
void proto_process_byte(uint8_t);
void process_pkt(uint8_t, uint8_t *, size_t);

#endif /* CIRCULAR_BUFFER_INC_CIRCULAR_BUFFER_H_ */
